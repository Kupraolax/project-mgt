      ...
      <div className="px-4 xl:px-6">
        ...
        <div className="pb-6 pt-6 lg:pb-4 lg:pt-8">
          <Header
            ...
            buttonComponent={
              <button
                className="new-project-button flex items-center rounded-md px-3 py-2 text-white"
...
const TabButton = ({ name, icon, setActiveTab, activeTab }: TabButtonProps) => {
  ...
  return (
    <button
      className={`relative flex items-center gap-2 px-1 py-2 text-gray-600 after:absolute after:-bottom-2.25 after:left-0 after:h-px after:w-full hover:text-blue-600 dark:text-neutral-300 dark:hover:text-white sm:px-2 lg:px-4 ${
